function Decoy(timeline) {
    ...
    ["Air Fryer Oven", "Basket size (qt)", "Max. Temperature (ºF)"], // Might need to add special character
    ...
    var presentation = {
		...
		stimulus: function(){ 
            ...
            return "<div style='position:absolute;top:6%;width:100%;display:table;left:0;'>"+
                ...
                "<p style='position:absolute;top:5px;right:47.5px;font-size:1.5em;font-weight:bold;line-height:1.4'>" + 
                "Option 1" + "</p></div>" +
    ...
    */
    ...
    /**
     "<div style='position:absolute;top:6%;width:100%;display:table;left:0;'>"+
                ...
                "<p style='position:absolute;top:20px;font-size:1.6em;font-weight:bold;line-height:1.4'><br><br>" +
                "D1" + ":<br><br><br><br>" + "D2" + ":</p>" + 
                "</div>" + 
		...
		stimulus: "<div style='position:absolute;top:6%;width:100%;display:table;left:0;'>"+
                ...
                "<div style='position:absolute;top:100px;width:160px;height:420px;display:table;left:5%;'>"+
                "<p style='position:absolute;top:20px;font-size:1.6em;font-weight:bold;line-height:1.4'><br><br>" + "D1" + ":<br><br><br><br>" +
                "D2" + ":</p>" + 
                "</div>" + 
